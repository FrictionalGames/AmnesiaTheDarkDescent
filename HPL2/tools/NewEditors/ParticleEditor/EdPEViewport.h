...
class cCamModePE : public iCamMode
{
public:
	cCamModePE(cEdCamera*);
protected:
...
class cCamControllerPE : public iCamController
{
public:
	cCamControllerPE(cEdCamera*);

	bool OnViewportMouseDown(const cViewportClick&);
	bool OnViewportMouseUp(const cViewportClick&);

	bool IsActive() { return mbOrbiting || mbTracking || mbZooming || mbWheelUp || mbWheelDn; }
