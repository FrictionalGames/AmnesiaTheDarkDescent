...
#ifndef ED_WINDOW_GROUP_H
#define ED_WINDOW_GROUP_H
...
class cEdWindowGroup : public iEdPopUp
{
public:
	cEdWindowGroup(iEditor*);
	~cEdWindowGroup();
...
protected:
	...
	cEdInputBool* mpInpVisible;

	cWidgetListBox* mpListGroups;
	cWidgetListBox* mpListGroupEntities;
};

//--------------------------------------------------------------------

#endif // ED_WINDOW_GROUP_H
