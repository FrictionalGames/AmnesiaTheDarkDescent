...
#ifndef ED_EDIT_PANE_SHAPES_H
#define ED_EDIT_PANE_SHAPES_H

#include "../Common/EdMultiScnObjEditPane.h"

//---------------------------------------------------------------------

class cEdEditPaneShapes : public cEdMultiScnObjEditPane
{
public:
	cEdEditPaneShapes(iEdObject*);
	virtual ~cEdEditPaneShapes();
