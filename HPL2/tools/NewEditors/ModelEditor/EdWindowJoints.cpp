...
cEdWindowJoints::cEdWindowJoints(iEdEditMode* apEditMode) : iEdScnObjCreatorPane(apEditMode)
{
}

cEdWindowJoints::~cEdWindowJoints()
{
}
...
void cEdWindowJoints::OnCreateLayout()
{
