...
{
public:
	cEditorActionBodyAddShapes(iEdWorld* apEditorWorld, int alBodyID, const tIntList& alstShapeIDs);
...
{
public:
	cEditorActionBodyRemoveShapes(iEdWorld* apEditorWorld, const tIntList& alstBodyShapeIDs);
