...
#ifndef ED_EDIT_MODE_PARTICLE_SYSTEMS_H
#define ED_EDIT_MODE_PARTICLE_SYSTEMS_H
...
class cEdWindowParticleSystems;

class iEdWorld;

//------------------------------------------------------------

class cEdEditModeParticleSystems : public iEdEditModeScnObjCreator
{
public:
	cEdEditModeParticleSystems(iEditor* apEditor);
...
#endif // ED_EDIT_MODE_PARTICLE_SYSTEMS_H
