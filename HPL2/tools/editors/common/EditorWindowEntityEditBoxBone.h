...
#ifndef HPLEDITOR_EDITOR_WINDOW_ENTITY_EDIT_BOX_BONE_H
#define HPLEDITOR_EDITOR_WINDOW_ENTITY_EDIT_BOX_BONE_H
...
#endif // HPLEDITOR_EDITOR_WINDOW_ENTITY_EDIT_BOX_BONE_H
